...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-stone-950/95 backdrop-blur border-b border-white/10">
      ...
      {/* Mobile menu */}
      {open && (
        <div className="md:hidden border-t border-white/10 bg-stone-950 px-6 py-4 flex flex-col gap-4 text-sm font-medium">
